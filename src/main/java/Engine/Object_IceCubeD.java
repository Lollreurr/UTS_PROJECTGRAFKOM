...
public class Object_IceCubeD extends ShaderProgram{
    ...
    List<Object_IceCubeD> childObjectIceCubeD;
    List<Float> centerPoint;

    public List<Object_IceCubeD> getChildObject(){
        return childObjectIceCubeD;
    }

    public void setChildObject(List<Object_IceCubeD> childObjectIceCubeD){
        this.childObjectIceCubeD = childObjectIceCubeD;
    }
    ...
    public Object_IceCubeD(List<ShaderModuleData> shaderModuleDataList
        ...
        childObjectIceCubeD = new ArrayList<>();
    ...
    public void drawSetup(Camera_IceCubeD cameraIceCubeD, Projection_IceCubeD projectionIceCubeD){
        bind();
        ...
        uniformsMap.setUniform(
                "view", cameraIceCubeD.getViewMatrix()
        );
        uniformsMap.setUniform(
                "projection", projectionIceCubeD.getProjMatrix()
        );
    ...
    public void draw(Camera_IceCubeD cameraIceCubeD, Projection_IceCubeD projectionIceCubeD){
        drawSetup(cameraIceCubeD, projectionIceCubeD);
        // Draw the vertices
        //optional
        ...
        glDrawArrays(GL_TRIANGLE_FAN,
                0,
                vertices.size());
        for(Object_IceCubeD child: childObjectIceCubeD){
            child.draw(cameraIceCubeD, projectionIceCubeD);
        }
    }
